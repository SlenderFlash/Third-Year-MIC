...
# routine d'évaluation directe en une multitude de points :
#------------------------------------------------------------
...
# MODIF pour tracé partie 3
#=============================
# force de lissage (devient une liste)
RhoGlobal = 1.5**np.arange(1,41,1)
# stockage xinf pour chaque rho
XX_inf = np.zeros(len(RhoGlobal))
# compteur pour compter les rho
i_rho = 0

# MODIF Pour afficher les courbes en mode film
#-------------------------------------------
plt.show()
plt.grid()
axes = plt.gca()
...
# Boucle globale sur tous les Rho
#==================================
for rhoGlobal in RhoGlobal :
    ...
    # MODIF : STOCKAGE du Xinf
    #===========================================
    XX_inf[i_rho] = X_inf[i_pente_max]
...
# MODIF : Tracé de xinflexio=f(rho)
#===========================================
# plt.semilogx(RhoGlobal, XX_inf,'-xb')
# plt.xlabel("rho")
# plt.ylabel("x_inflexion")
# plt.title("x_inflexion=f(rho)")
# plt.grid()
# plt.show()
